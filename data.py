...
# Opening weekend as fraction of total domestic gross
LEGS_BY_GENRE = {
...
# Seasonal multiplier on opening weekend (1.0 = average)
MONTH_FACTORS = {
...
# Star power tiers → opening weekend boost (millions)
STAR_POWER = {
...
# International multiplier (international gross / domestic gross)
INTL_MULTIPLIER = {
